  ...
  return (
    <main id="main" className="mx-auto max-w-3xl px-4 py-10">
      ...
      <p className="mt-3 text-sm text-muted">
        Use the free calculator for an indicative planning estimate, or request
        roofing quotes for a specific property. These are different things.
      </p>
      ...
      <ul className="mt-3 list-disc space-y-2 pl-5">
        <li>
          <strong>Roof area and pitch</strong> — more square metres, steeper
          work, more labour.
        </li>
        <li>
          <strong>Covering</strong> — concrete is the budget workhorse; clay
          costs more to buy and lay; natural slate needs skilled labour.
        </li>
        <li>
          <strong>Shape</strong> — hips, valleys, dormers and chimneys add
          cutting, flashing and time.
        </li>
        <li>
          <strong>Scaffolding and access</strong> — a typical two-storey house
          often needs a full scaffold; parking or rear access can add hire days.
        </li>
        <li>
          <strong>Strip-out and waste</strong> — old coverings, felt and battens
          have to leave the site.
        </li>
        <li>
          <strong>What is found underneath</strong> — rotten timber, failed
          underlay or a deck that will not take a new covering.
        </li>
      </ul>
